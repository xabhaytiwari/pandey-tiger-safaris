...
export default function JungleAmbiance() {
  ...
  return (
    <button
      ...
      className={`h-9 px-3.5 rounded-full text-[11px] font-bold transition-all flex items-center gap-1.5 border active:scale-95 ${
        isPlaying
    ...
    >
      ...
      <span>{isPlaying ? "Jungle ON" : "Jungle Sound"}</span>
