...
export default function GallerySlideshow() {
  ...
  return (
    <div className="bg-zinc-950 border border-white/10 rounded-3xl p-6 md:p-8 space-y-6 shadow-2xl overflow-hidden relative">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 border-b border-white/10 pb-4">
        <div>
          <span className="text-xs font-mono uppercase tracking-widest text-orange-500 font-bold flex items-center gap-1.5">
            <Sparkles className="w-4 h-4" /> Authentic Photo Showcase
          </span>
          <h3 className="text-2xl font-black text-white mt-1">Owner & Real Fleet Gallery</h3>
        </div>
