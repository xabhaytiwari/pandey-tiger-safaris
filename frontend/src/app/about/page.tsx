      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <p className="text-amber-400 font-semibold text-lg flex items-center gap-2">
            <Phone className="w-5 h-5" /> Direct Call: +91 9425331205
          </p>
          <p className="text-zinc-300 text-base leading-relaxed font-light">
            {founder?.bio || "With over 20 years of experience traversing the dense teak and bamboo forests of Bandhavgarh, Dinesh Pandey (+91 9425331205) is renowned for royal Bengal tiger tracking, wildlife photography expeditions, and luxury transport coordination."}
          </p>
        ...
        <div className="relative">
          <img src={founder?.image_url || "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=800"} alt="Dinesh Pandey" className="w-full h-[450px] object-cover rounded-3xl border border-white/10 shadow-2xl" />
        </div>
      </div>
    </main>
  );
