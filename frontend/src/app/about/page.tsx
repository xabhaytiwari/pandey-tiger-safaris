...
import { Phone, MapPin, Award, Users, Shield } from "lucide-react";
    ...
    <main className="min-h-screen max-w-5xl mx-auto px-6 py-12 space-y-16">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <span className="text-xs font-mono uppercase tracking-widest text-amber-400">Business Owner & Tour Operator</span>
          ...
          <div className="pt-4 border-t border-white/10 flex flex-wrap gap-6 text-xs text-zinc-400">
            <div className="flex items-center gap-2"><Users className="w-4 h-4 text-amber-400" /> Army of Licensed Guides</div>
            <div className="flex items-center gap-2"><Award className="w-4 h-4 text-amber-400" /> End-to-End Tour Operator</div>
